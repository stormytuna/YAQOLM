...
public class StardustPrefixHammer : ModItem
{
    ...
    public override bool CanRightClick() => Main.mouseItem.accessory && Main.mouseItem.prefix != PrefixID.Menacing;
...
public class StardustPrefixHammerGlobalItem : GlobalItem
{
    ...
    public override bool CanRightClick(Item item) {
        return Main.mouseItem.type == ModContent.ItemType<StardustPrefixHammer>() && Main.mouseItem.stack > 0
