...
public class QuantumStrongbox : ModItem
{
	...
	public override void ModifyTooltips(List<TooltipLine> tooltips) {
		TooltipLine tooltipLine = tooltips.FirstOrDefault(t => t.Name == "Tooltip0");
		...
		tooltips.Insert(index, new TooltipLine(Mod, "Tooltip1", text));
		tooltips.Insert(index + 1, new TooltipLine(Mod, "Tooltip2", "Right click to switch mode"));
