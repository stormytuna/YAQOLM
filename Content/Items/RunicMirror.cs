...
public class RunicMirrorSystem : ModSystem
{
	public override void Load() {
		TeleportPylonsSystem.IsPlayerNearAPylon += TeleportPylonsSystem_IsPlayerNearAPylon;
	...
	private bool TeleportPylonsSystem_IsPlayerNearAPylon(TeleportPylonsSystem.orig_IsPlayerNearAPylon orig, Player player) {
