...
public class QuantumStrongboxUiSystem : ModSystem
{
    ...
    public static void Show() => Instance.QuantumStrongboxUi?.SetState(Instance.QuantumStrongboxUiState);

    public static void Hide() => Instance.QuantumStrongboxUi?.SetState(null);
